...
def data ():
    ...
    # Fetching data from config_db for TX_MONITORS_ARGS
    tx_monitor_data = config_db.get_table('TX_MONITORS_ARGS')
...
def summary(db):
    ...
    txstate_keys = db.db.get_all(db.db.STATE_DB, "TX_TABLE")
